...
<body>
    ...
    <div class="navbar-top">
        ...
        <div class="side-nav-panel-right">
            <a href="#" data-activates="slide-out-right" class="side-nav-left"><i class="fa fa-user">
            @if(!empty(session('nameinfo')))
    ...
    <div class="side-nav-panel-right">
        <ul id="slide-out-right" class="side-nav side-nav-panel collapsible">
            <li class="profil">
                <img src="{{asset('mstore/img/325199.jpg')}}" alt="">
                <h2>@if(!empty(session('nameinfo')))
                {{Session::get('nameinfo')}}
                @else
                <a href="login"i>前往登录</a>
            @endif</h2>
            </li>
            <li><a href="setting.html"><i class="fa fa-cog"></i>Settings</a></li>
            <li><a href="about-us.html"><i class="fa fa-user"></i>About Us</a></li>
            <li><a href="contact.html"><i class="fa fa-envelope-o"></i>Contact Us</a></li>
            <li><a href="/index/login"><i class="fa fa-sign-in"></i>登录</a></li>
            <li><a href="loginout"><i class="fa fa-user-plus"></i>退出登录</a></li>
        </ul>
    </div>
    <!-- end side nav right-->
        ...
        <div class="modal-content">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col s4">
                        <a href="loginout" class="button-link">
                            <div class="menu-link">
                                <div class="icon">
                                    <i class="fa fa-sign-in"></i>
                                </div>
                ...
                <div class="container">
                    <div class="content">
                        ...
                        <div class="cart-2">
                            <div class="row">
                                <div class="col s5">
                                    <img src="/mstore/img/325199.jpg" alt="">
                                </div>
                                <div class="col s7">
                                    <h5><a href="">Fashion Men's</a></h5>
                                </div>
